...
/*
INSERT INTO "PUBLIC"."NOTIFICATION" (ID,CONTENT,CREATIONDATE,TITLE,TYPE,USER_ID,STATUS) VALUES (1,'Rendez-vous fixé blabla',{ts '2017-06-09 10:06:02.146000000'},'Notification title','SIMPLE',1,'NOTREAD');
INSERT INTO "PUBLIC"."NOTIFICATION" (ID,CONTENT,CREATIONDATE,TITLE,TYPE,USER_ID,STATUS) VALUES (2,'Rendez-vous annulé',{ts '2017-06-04 10:06:02.146000000'},'Notification title','CONFIRM',1,'NOTREAD');
INSERT INTO "PUBLIC"."NOTIFICATION" (ID,CONTENT,CREATIONDATE,TITLE,TYPE,USER_ID,STATUS) VALUES (3,'Description',{ts '2017-06-07 10:06:02.146000000'},'Notification title','REDIRECT',1,'READ');
INSERT INTO "PUBLIC"."NOTIFICATION" (ID,CONTENT,CREATIONDATE,TITLE,TYPE,USER_ID,STATUS) VALUES (4,'Rien',{ts '2017-06-06 10:06:02.146000000'},'Notification title','MEETING',2,'NOTREAD');
INSERT INTO "PUBLIC"."NOTIFICATION" (ID,CONTENT,CREATIONDATE,TITLE,TYPE,USER_ID,STATUS) VALUES (5,'Bite',{ts '2017-06-05 10:06:02.146000000'},'Notification title','REMARK',2,'READ');
*/