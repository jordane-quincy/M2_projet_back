...
INSERT INTO "PUBLIC"."OFFER" (ID,DESCRIPTION,DURATION,KEYWORDS,TITLE,DOMAIN_ID,USER_ID) VALUES (1, 'Cours de développement web afin d''apprendre à utiliser les langages HTML, CSS, JSS, PHP, SQL', 1, 'css,developpement,web,utiliser,afin,php,html,langages,jss,cours,dapprendre,sql', 'Cours de développement web', 3, 1);
INSERT INTO "PUBLIC"."OFFER" (ID,DESCRIPTION,DURATION,KEYWORDS,TITLE,DOMAIN_ID,USER_ID) VALUES (2, 'Cours de développement JAVA afin d''apprendre à utiliser les langages JAVA, JEE', 1, 'java,developpement,utiliser,afin,langages,jee,cours,dapprendre', 'Cours JAVA', 4, 1);
INSERT INTO "PUBLIC"."OFFER" (ID,DESCRIPTION,DURATION,KEYWORDS,TITLE,DOMAIN_ID,USER_ID) VALUES (3, 'Cours de développement JEE', 1, 'developpement,jee,cours', 'Cours JEE', 1, 2);
INSERT INTO "PUBLIC"."OFFER" (ID,DESCRIPTION,DURATION,KEYWORDS,TITLE,DOMAIN_ID,USER_ID) VALUES (4, 'Cours de développement mobile, nouvelles technologies', 1, 'nouvelles,technologies,xamarin,developpement,mobile,cours', 'XAMARIN', 4, 3);
