...
INSERT INTO user VALUES (1, {ts '1990-06-07 00:00:00.00000000'}, 5, 'STUDENT', NULL, 'Jordan', 'jordane.quincy@etu.univ-valenciennes.fr', 'QUINCY', 'jquincy', 5, 1);
INSERT INTO user VALUES (2, {ts '1980-06-07 00:00:00.00000000'}, 1, 'TEACHER', NULL,'Mickael', 'mikael.desertot@univ-valenciennes.fr', 'DESERTOT', 'mdesertot', 7, 2);
INSERT INTO user VALUES (3, {ts '1979-03-02 00:00:00.00000000'}, 1, 'TEACHER', NULL, 'Sylvain', 'Sylvain.Lecomte@univ-valenciennes.fr', 'LECOMTE', 'slecomte', 10, 3);
INSERT INTO user VALUES (4, {ts '1993-03-02 00:00:00.00000000'}, 1, 'STUDENT', NULL, 'John', 'John.Ypeurien@univ-valenciennes.fr', 'YPEURIEN', 'jypeurien', 15, 4);
INSERT INTO user VALUES (5, {ts '1973-03-02 00:00:00.00000000'}, 1, 'STUDENT', NULL, 'James', 'James.Bond@univ-valenciennes.fr', 'BOND', 'jbond', 15, 5);
INSERT INTO user VALUES (6, {ts '1988-03-02 00:00:00.00000000'}, 1, 'STUDENT', NULL, 'Jon', 'Jon.Snow@univ-valenciennes.fr', 'SNOW', 'jsnow', 16, 6);
INSERT INTO user VALUES (7, {ts '1893-03-02 00:00:00.00000000'}, 1, 'STUDENT', NULL, 'Louis', 'Louis.Quatorze@univ-valenciennes.fr', 'QUATORZE', 'lquatorze', 11, 7);
...
INSERT INTO "PUBLIC"."VALIDATED_SKILLS" (USER_ID,VALIDATED,SKILLS_KEY) VALUES (1 /*not nullable*/,false,1 /*not nullable*/);
INSERT INTO "PUBLIC"."VALIDATED_SKILLS" (USER_ID,VALIDATED,SKILLS_KEY) VALUES (1 /*not nullable*/,false,2 /*not nullable*/);
INSERT INTO "PUBLIC"."VALIDATED_SKILLS" (USER_ID,VALIDATED,SKILLS_KEY) VALUES (1 /*not nullable*/,true,3 /*not nullable*/);