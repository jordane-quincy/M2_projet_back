...
public class SearchController {
	...
	/*
	 * @RequestMapping(value = "/subject/{domainId}", method =
	 * RequestMethod.GET, produces = "application/json") public List<Subject>
	 * getSubject( HttpServletRequest request,
	 * 
	 * @PathVariable(required=true) Long domainId) throws Exception { try {
	 * List<Subject> subjects = subjectService.findSubjectsByDomainId(domainId);
	 * return subjects; } catch (Exception e) { throw new
	 * Exception("Impossible de récupérer la liste de matières pour le domaine n°"
	 * + domainId); } }
	 */
}
